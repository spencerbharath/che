...
public class WorkspaceManagerTest {
    ...
    public void getsWorkspaceByIdWithRuntime() throws Exception {
        ...
        final WorkspaceImpl result = workspaceManager.startWorkspace(workspace.getId(),
    ...
    public void getsWorkspaceByKey() throws Exception {
        ...
        final WorkspaceImpl result =
                workspaceManager.getWorkspace(workspace.getNamespace() + ":" + workspace.getConfig().getName());
    ...
    @Test
    public void getsWorkspaceByNameReturnWorkspaceWithStatusEqualToItsRuntimeStatus() throws Exception {
        final WorkspaceImpl workspace = createAndMockWorkspace();
        mockRuntime(workspace, STARTING);
    ...
    @Test
    public void updatesWorkspaceAndReturnWorkspaceWithStatusEqualToItsRuntimeStatus() throws Exception {
        final WorkspaceImpl workspace = createAndMockWorkspace();
        mockRuntime(workspace, STARTING);
    ...
    private WorkspaceImpl createAndMockWorkspace(WorkspaceConfig cfg, String namespace) throws Exception {
    ...
    private void mockStart(Workspace workspace) throws Exception {
        ...
        when(runtimes.startAsync(eq(workspace),
                                 eq(workspace.getConfig().getDefaultEnv()),
                                 any())).thenReturn(cmpFuture);
    }
    ...
    private static WorkspaceConfigImpl createConfig() {
        MachineConfigImpl machineConfig = new MachineConfigImpl(singletonList("org.eclipse.che.ws-agent"),
                                                                null,
