...
public class BasicActiveFileHandler implements ActiveFileHandler {
   ...
   *
   * <p>{@link BasicActiveFileHandler#findInOpenedEditors(Location, AsyncCallback)} {@link
   * BasicActiveFileHandler#findInProject(Location, AsyncCallback)} {@link
   * BasicActiveFileHandler#findInWorkspace(Location, AsyncCallback)} {@link
   * BasicActiveFileHandler#searchSource(Location, AsyncCallback)}
   *
